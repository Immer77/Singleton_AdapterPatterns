...
public class PersonCollection implements Iterable<Person>{
    ...
    // TODO
    private class InnerClassIterator implements Iterator<Person>{

        int position = 0;

        int lastKnownSize = size;
        public InnerClassIterator(){
        ...
        public Person next() {
            if(lastKnownSize == size){
                ...
                throw new ConcurrentModificationException("Der er blevet ændret i size");
            }
        }
    }
